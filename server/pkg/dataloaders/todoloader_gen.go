...
func (l *TodoLoader) Load(key string) (*db.Todo, error) {
...
func (l *TodoLoader) LoadThunk(key string) func() (*db.Todo, error) {
	l.mu.Lock()
...
func (l *TodoLoader) LoadAll(keys []string) ([]*db.Todo, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *TodoLoader) LoadAllThunk(keys []string) func() ([]*db.Todo, []error) {
	results := make([]func() (*db.Todo, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *TodoLoader) Prime(key string, value *db.Todo) bool {
	l.mu.Lock()
	var found bool
...
func (l *TodoLoader) unsafeSet(key string, value *db.Todo) {
	if l.cache == nil {
